        ...
        >
          ...
          <Box paddingLeft={isCollapsed ? undefined : "10%"}>
            ...
            <Item
              ...
              to={`/admin/${locale}/companies`}
              icon={<BusinessOutlinedIcon sx={{ color: colors.grey[100] }} />}
              pathname={pathname}
            />

            {/* Create Company */}
            <Item
              title={t("admin.sidebar.createCompany")}
              to={`/admin/${locale}/companies/new`}
              icon={<AddBusinessOutlinedIcon sx={{ color: colors.grey[100] }} />}
              pathname={pathname}
            />
          </Box>
        </Menu>
